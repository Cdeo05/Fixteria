                ...
                <div class="row">
                  <form method="post" action="booking.php">
                    ...
                    <div class="form-group col-md-4 col-sm-4 col-xs-12 select_box ">
                      <select name='selected-service'class="form-control" style="border-radius: 0px;height: 47px;font-size: 15px;color: #8e8e8e;box-shadow: none;border-color: #dddddd;">
                        <option value="" selected disabled hidden>Select Service</option>
                        <?php
                            $db = mysqli_connect('localhost', 'root', '', 'sem5project');
                            $query = "SELECT distinct Name FROM service";
                    ...
                    <div class="form-group col-md-4 col-sm-4 col-xs-12 padding-r">
                      <button class="btn btn-primary promo_apply" name="book-now"  type="submit"> BOOK NOW </button>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div class="booking_form">
              <div class="container-fluid">
                <div class="row">
                    ...
                    <!--Service Address-->
                    <h2>Start Booking Appointments and Get Instant Services!</h2>
                    <h2><a href='user-login.php'>Click here to Login</a></h2>
