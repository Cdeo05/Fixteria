...
<div id="wrapper"> 
  ...
  <form method="post" action="worker-login.php">
  	...
  	<div class="input-group">
  		<button type="submit" class="btn" name="login_worker">Login</button>
  	</div>
  	<p>
  		Not yet a member? <a href="worker-register.php">Sign up</a>
  	</p>
  </form>
